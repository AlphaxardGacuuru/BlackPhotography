							...
							<div className="text-center">
								...
								<center>
									<div className="p-2 mt-4">
										<a href="tel:0700364446" style={{ color: "black" }} data-toggle="tooltip"
									...
									<div className="p-2 mt-4">
										<a href="sms:0700364446" style={{ color: "black" }}>
											<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
									...
									<div className="p-2 mt-4">
										<a href="https://wa.me/+2540700364446" data-toggle="tooltip" style={{ color: "black" }}
									...
									<div className="p-2 mt-4">
										<a href="mailto:alphaxardgacuuru47@gmail.com?subject = Photography&body = Enquiry"
											data-toggle="tooltip" style={{ color: "black" }} data-placement="bottom" title="Email">
											<svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor"
									...
									<div className="p-2 mt-4">
										<a href="https://www.instagram.com/alphaxard_gacuuru" style={{ color: "black" }}
									...
									<div className="p-2 mt-4">
										<a href="https://www.facebook.com/alphaxard.gacuuru" style={{ color: "black" }}
